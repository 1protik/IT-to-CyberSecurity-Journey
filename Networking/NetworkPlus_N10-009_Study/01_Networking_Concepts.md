...
| Physical     | Hardware, signals, cables               | Cables, Fiber, Signal             |
...
**Key Notes:**
- Tricks to memorize : <p>Layer 1 to Layer 7 - ***P***lease ***D***o ***N***ot ***T***hrow ***S***ausage ***P***izza ***A***way <p>
  Layer 7 to Layer 1 - ***A***ll ***P***eople ***S***eem ***T***o ***N***eed ***D***ata ***P***rocessing 
